  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="relative pl-6 sm:pl-8 md:pl-40 space-y-4 sm:space-y-5">
          ...
          {experiences.map((exp, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute -left-[19px] sm:-left-[23px] md:-left-[27px] top-4 z-20 flex items-center justify-center">
                  {exp.isCurrent ? (
                ...
                {/* Left Date Label for Desktop (Never overlaps node) */}
                <div className="hidden md:flex flex-col items-end absolute -left-40 top-3 w-32 pr-4 text-right select-none transition-colors duration-200">
                  <span
                ...
                {/* Experience Card */}
                <div
                  className={`bg-[var(--card)] text-[var(--card-foreground)] border rounded-[var(--radius)] p-3.5 sm:p-4.5 shadow-xs transition-all duration-300 ${
                    isSelected
